...
export class CustomComponent implements OnInit {
                                                              ...
                                                              <tr>
                                                                  <td class="mcnImageContent" valign="top"
                                                                      ...
                                                                      <img align="center" alt=""
                                                                          src="https://mcusercontent.com/80c4e0529b85d120cd019f4a0/images/2c79a892-92ef-4979-9d09-65010fa43c90.jpg"
                                                                          width="214.32"
                                                                          style="max-width:781px; padding-bottom: 0; display: inline !important; vertical-align: bottom;"
                                                                          class="mcnImage">
                                                          ...
                                                          <tbody>
                                                              <tr>
                                                                  ...
                                                                  <td valign="top" class="mcnTextContent"
                                                                      ...
                                                                      <h1>Thank You,*|IF:FNAME|* *|FNAME|*.*|END:IF|*</h1>
      
                                                                      <p><span style="font-size:16px">I've received your
                                                                              request, and I will reply to you soon! Here's a
                                                                              summary of what I got from your request:</span>
                                                                      </p>
                                              ...
                                              <tr>
                                                  <td valign="top" class="mcnTextBlockInner">
                                                      <div class="mcnTextContent">
                                                          <table
                                                              style="width:100%; font-size: 14px; padding: 1em; border-spacing: 0 0.7em; border-collapse:separate; ">
                                                              <tbody>
                                                                  <tr>
                                                                      <th>Item</th>
                                                                      <th>Type</th>
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      <td></td>
                                                                      <td></td>
                                                                      <td style="border-top:1px solid grey;">Total:</td>
                                                                      <td style="border-top:1px solid grey;">CAD$95</td>
                                                                  </tr>
                                                              </tbody>
                                                          </table>
                                                          <div style="padding: 1em;">
                                                              <h4>Your Message:</h4>
                                                              <p style="text-align:left; font-size: 14px;">Hey, can I get a
                                                                  drawing of the attached picture but like do this this this
                                                                  and then put a purple blellow background for the picture and
                                                                  also can i please have it printed and framed thanks</p>
                                                          </div>
                                                      </div>
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnCodeBlock">
                                          <tbody class="mcnTextBlockOuter">
                                              <tr>
                                                  <td valign="top" class="mcnTextBlockInner">
                                                      <div class="mcnTextContent">
                                                          <h4 style="padding-left: 1em;">Images you've provided:</h4>
                                                      </div>
                                                  </td>
                                              </tr>
                                          </tbody>
                                                                                                                                          ...
                                                                                                                                          <tbody>
                                                                                                                                              <tr>
                                                                                                                                                  ...
                                                                                                                                                  <td align="center"
                                                                                                                                                      ...
                                                                                                                                                      <a href="https://www.facebook.com/ovvisualss"
                                                                                                                                                          target="_blank"><img
                                                                                                                                          ...
                                                                                                                                          <tbody>
                                                                                                                                              <tr>
                                                                                                                                                  ...
                                                                                                                                                  <td align="center"
                                                                                                                                                      ...
                                                                                                                                                      width="24"
                                                                                                                                                      class="mcnFollowIconContent">
                                                                                                                                                      <a href="https://www.instagram.com/ov.visuals/"
                                                                                                                                                          target="_blank"><img
                                                                                                                                          ...
                                                                                                                                          <tbody>
                                                                                                                                              <tr>
                                                                                                                                                  ...
                                                                                                                                                  <td align="center"
                                                                                                                                                      ...
                                                                                                                                                      width="24"
                                                                                                                                                      class="mcnFollowIconContent">
                                                                                                                                                      <a href="mailto:ovvisuals@gmail.com"
                                                                                                                                                          target="_blank"><img
    ...
    handleFileInput(self, event) {
        let events = [];
        events = Object.values(event)
        console.log(events)
        this.imgur.auth(Object.values(event))
